...
namespace FunctionApp.TestHarness
{
    ...
    public class App
    {
        ...
        public async Task Run()
        {
            ...
            var test = await _powerBIService.RefreshDataflow("073a7c75-84de-4ace-9dbe-777617a0e3ff", "testSecret", "", "refreshTest", "ea6e65c7-8840-425b-a957-8c72609ac812", "https://ark-stg-kv-ads-aqye.vault.azure.net/", _funcAppLogger);
            //var test2 = await _powerBIService.CheckDataflowRefreshStatus("073a7c75-84de-4ace-9dbe-777617a0e3ff", "testSecret", "", "refreshTest", "ea6e65c7-8840-425b-a957-8c72609ac812", "https://ark-stg-kv-ads-aqye.vault.azure.net/", test, _funcAppLogger);
